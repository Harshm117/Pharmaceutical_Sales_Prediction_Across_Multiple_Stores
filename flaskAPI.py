...
rf_model_uri = "http://localhost:5000/mlflow/2abf9c4818b749068b7eca7e332e7f0a/artifacts/Random_forest_model"
loaded_rf_model = mlflow.sklearn.load_model(rf_model_uri)

# Load the trained LSTM model
lstm_model_path = "http://localhost:8888/tree/AI%20Course/Pharmaceutical%20Sales%20prediction%20across%20multiple%20stores/models/LSTM_sales-03-02-2024-13-50-02-435.pkl"
